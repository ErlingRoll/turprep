...
const errorTranslations: Record<string, string> = {
  ...
  "The day item date must be within the trip dates": "errors.dayItemDateOutsideTrip",
  "The activity date must be within the trip dates": "errors.activityOutsideTrip",
  "Invalid Google Maps link": "errors.googleMapsInvalid",
  ...
  "The new trip dates cannot exclude existing meals": "errors.tripDatesExcludeMeals",
  "Planned housing stays cannot overlap": "errors.housingOverlap",
